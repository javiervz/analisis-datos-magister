...
| 5 | herramientas de análisis | frecuencias/entropías, distancia de Hamming, herramientas básicas de estadística | entrega 1 |
...
| 9 | visualización de información lingüística | [mapas](https://geopandas.org/) e información espacial, [gráficos](https://matplotlib.org/) |
| 10 | fundamentos de análisis automático de datos | detección de patrones, regresiones lineales, agrupamiento |