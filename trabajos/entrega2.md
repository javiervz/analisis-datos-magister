...
1. Un **informe** de máximo 5 planas (en total, incluyendo referencias), en donde describa:
...
6. **Análisis de los datos.** Esta parte es incipiente para esta entrega, pero permite que propongan las primeras formas de analizar los datos. Les recomiendo:
    - tener en consideración un objetivo más general que lo que están presentando. De alguna forma, los resultados que presenten ahora son una parte (o una primera mirada) de lo que esperan entregar al finalizar el curso.
